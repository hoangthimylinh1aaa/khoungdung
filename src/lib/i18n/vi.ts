export const vi = {
  ...
  registerPage: {
    ...
    left_subtitle: 'Base cung cấp nền tảng tùy biến sâu, dễ dàng triển khai, và đáp ứng nhu cầu đặc thù của từng lĩnh vực',
    ...
    disclaimer_prefix: 'Bằng cách nhấn "nhận tư vấn giải pháp", tôi xác nhận rằng tôi đã đọc và đồng ý với ',
