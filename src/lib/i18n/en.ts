export const en = {
  ...
  registerPage: {
    ...
    left_subtitle: 'Base provides a deeply customizable platform, easy to deploy, and tailored to the specific needs of each industry',
    ...
    product_options: ['KD Commerce', 'KD Café', 'KD HRM', 'KD Chain', 'AI Integration', 'Other consulting'],
    email: 'Email',
    ...
    disclaimer_prefix: 'By clicking "get solution consulting", I confirm that I have read and agree to the ',
